...
class AuthTestSuite(unittest.TestCase):
    def _create_service_account_mock(self, service_account):
        ...
        from_service_account_info_mock.from_service_account_info.return_value = 'CREDENTIALS'
    ...
    def _create_service_account_with_subject_mock(self, service_account):
        ...
        with_subject_mock.with_subject.return_value = 'CREDENTIALS_WITH_SUBJECT'
        from_service_account_info_mock = Mock()
        from_service_account_info_mock.from_service_account_info.return_value = with_subject_mock
    ...
    def test_auth_set_google_credentials_with_subject(self, service_account):
        service_account = self._create_service_account_with_subject_mock(service_account)
